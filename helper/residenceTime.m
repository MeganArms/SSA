function [f,x,residence_time,residence_time_CI] = residenceTime(traj,varargin)
...
counts = histcounts(reside*exposure,edges);
[f,x] = ecdf(reside*exposure); 
[residence_time,residence_time_CI] = expfit(reside*exposure);